...
<div class="right-contentbody">
	<div class="board-work-article">
		<div class="main-container">
			<div class="title-worktime">
				<div class="worktime-header">
					<h1>
						<i class="bi bi-person-fill"></i>근태현황
					</h1>
				</div>
			...
			<div class="total-worktime">
				<table class="table table-border table-list total-worktime"
			...
			<div class="calendar-worktime">
				<table class="table table-border table-form-work">
					<thead>
						<tr>
							<th>날짜</th>
							<th>출근</th>
